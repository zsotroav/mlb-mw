...
sched.add_job(episode_update, 'date', run_date=datetime(2022, 10, 28, 10, 50, 00), args=['Determination',
                                                                                       'Determination',
                                                                                       Mode.WW])
...
sched.add_job(episode_update, 'date', run_date=datetime(2022, 10, 29, 14, 00, 30), args=['Multiplication',
                                                                                       'Multiplication',
                                                                                       Mode.FULL])
sched.start()
